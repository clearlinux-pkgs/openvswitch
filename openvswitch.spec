...
Version  : 3.3.1
Release  : 83
URL      : https://www.openvswitch.org/releases/openvswitch-3.3.1.tar.gz
Source0  : https://www.openvswitch.org/releases/openvswitch-3.3.1.tar.gz
...
%prep
%setup -q -n openvswitch-3.3.1
cd %{_builddir}/openvswitch-3.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722357412
unset LD_AS_NEEDED
