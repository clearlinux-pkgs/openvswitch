...
Version  : 3.5.1
Release  : 89
URL      : https://www.openvswitch.org/releases/openvswitch-3.5.1.tar.gz
Source0  : https://www.openvswitch.org/releases/openvswitch-3.5.1.tar.gz
...
%prep
%setup -q -n openvswitch-3.5.1
cd %{_builddir}/openvswitch-3.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748971457
unset LD_AS_NEEDED
