...
Source0  : https://www.openvswitch.org/releases/openvswitch-3.5.0.tar.gz
...
%prep
%setup -q -n openvswitch-3.5.0
cd %{_builddir}/openvswitch-3.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739825859
unset LD_AS_NEEDED
