...
Source0  : https://www.openvswitch.org/releases/openvswitch-3.4.1.tar.gz
...
%prep
%setup -q -n openvswitch-3.4.1
cd %{_builddir}/openvswitch-3.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731948352
unset LD_AS_NEEDED
